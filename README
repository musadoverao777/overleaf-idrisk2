...
- Degree:  meec, meic, mem, mesw, mci, mia
...
Current version: v2026
feupteses.sty: 1.1.6

Changes for v2025a:
1. added "mia" option for MIA
2. replaced url package by xurl package
3. fixed ISO style bug (no comma after name) - provided by Carla Lopes
...
- First version created in 2008 by JCF & JCL @ fe.up.pt
