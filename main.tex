...
%%
%% Read the documentation inline and in the included `README` file
%%
...
%% mia     Master's degree in Master Artificial Intelligence
...
%% PT
%\usepackage[meic,portugues]{feupteses}
...
\copyrightnotice{$<$Name of the Author, \the\year{}$>$}
%\copyrightnotice{$<$Nome do Autor, \the\year{}$>$}
...
\committeemember{Examiner}{Prof.\ $<$Name of the Professor$>$}
\committeemember{Member}{Prof.\ $<$Name of the Professor$>$}
...
\begin{Prolog}
  ...
  \include{frontmatter/ethics}   % the declaration of honour
